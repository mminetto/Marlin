...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 21.8910
    #define DEFAULT_Ki 1.5416
    #define DEFAULT_Kd 77.7131
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 105.8452
  #define DEFAULT_bedKi 19.1749
  #define DEFAULT_bedKd 389.5103
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 402, 396, 1596, 552 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS / 2), 10 }
